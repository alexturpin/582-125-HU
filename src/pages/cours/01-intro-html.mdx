...
On peut créer des listes sans ordre avec `<ul>` et `<li>`.
...
Ou encore des listes avec ordre en remplaceant `<ul>` par `<ol>`.
...
Créez une page HTML avec les composantes suivantes:

- Une en-tête de niveau 1 avec votre nom
- Une en-tête de niveau 2 désignée "Renseignements personnels"
- Un paragraphe qui donne votre nom et un peu d'information sur où vous avez grandi
- Un paragraphe qui décrit ce que vous aimez faire dans vos temps libres
- Une en-tête de niveau 3 désignée "Citation préférée"
- Un bloc de citation contenant votre citation préférée
- Une en-tête de niveau 2 désignée "Mes trucs préférés"
- Une liste imbriquée sur deux niveaux
  - Le premier niveau doit contenir une liste non ordonnée avec 3 catégories de choses préférées
  - Le deuxième niveau sous chaque catégorie doit contenir une liste ordonnée avec 3 items préférés
